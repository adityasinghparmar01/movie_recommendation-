...
API_BASE = "https://movie-recommendation-kilb.onrender.com" or "http://127.0.0.1:8000"   # this is th elink from backend -> render or your local backend  whicch is created when you deploy your git hub rep on render.com
